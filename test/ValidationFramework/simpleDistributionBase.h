...
#ifndef __SIMPLEDISTRIBUTION__
#define __SIMPLEDISTRIBUTION__
...
class simpleDistributionBase{
	
public:
	simpleDistributionBase();
	simpleDistributionBase(PlotCompareUtility*);
	~simpleDistributionBase();
