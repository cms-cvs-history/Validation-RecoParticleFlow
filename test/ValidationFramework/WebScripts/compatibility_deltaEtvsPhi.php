...
<head>
  ...
  <script type="text/javascript">
    ...
    function tn_l(bin) {
      clear_r()
      document.getElementById("thumblink_l").href = "DeltaEtvsPhi/DeltaEtvsPhiCompare_etBin" + bin + ".gif"
      document.getElementById("thumb_l").src = "DeltaEtvsPhi/DeltaEtvsPhiCompare_etBin" + bin + ".gif"
    ...
    function tn_r(bin) {
      clear_l()
      document.getElementById("thumblink_r").href = "DeltaEtvsPhi/DeltaEtvsPhiCompare_etBin" + bin + ".gif"
      document.getElementById("thumb_r").src = "DeltaEtvsPhi/DeltaEtvsPhiCompare_etBin" + bin + ".gif"
...
<div id="main_d">
<img src="DeltaEtvsPhidET_Score_vs_et.gif" usemap="#results" alt="" style="border-style: none;">
...
<?
	...
	for($i=1;$i<=100;$i++)
	{
		echo "<area shape=rect coords=".($xpos+($i-1)*7.36).",410,".($ypos+($i-1)*7.36).",39\n";
 		if($i<10)
 		{
 			echo "href=DeltaEtvsPhi/DeltaEtvsPhiCompare_etBin000".$i.".gif\n";
 			echo "onMouseOver=tn_r('000".$i."')>\n";
 		}
 		else if($i<100)
 		{
 			echo "href=DeltaEtvsPhi/DeltaEtvsPhiCompare_etBin00".$i.".gif\n";
...
<div id="All bins"><img src=DeltaEtvsPhidEt_Allbins.gif></div>
<div id="sigma"><img src=DeltaEtvsPhiSigmaEtOverEt_vs_et.gif></div>
