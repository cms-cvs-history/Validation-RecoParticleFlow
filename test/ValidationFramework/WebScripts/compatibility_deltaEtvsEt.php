...
<head>
  ...
  <script type="text/javascript">
    ...
    function tn_l(bin) {
      clear_r()
      document.getElementById("thumblink_l").href = "DeltaEtvsEt/DeltaEtvsEtCompare_etBin" + bin + ".gif"
      document.getElementById("thumb_l").src = "DeltaEtvsEt/DeltaEtvsEtCompare_etBin" + bin + ".gif"
    ...
    function tn_r(bin) {
      clear_l()
      document.getElementById("thumblink_r").href = "DeltaEtvsEt/DeltaEtvsEtCompare_etBin" + bin + ".gif"
      document.getElementById("thumb_r").src = "DeltaEtvsEt/DeltaEtvsEtCompare_etBin" + bin + ".gif"
...
<div id="main_d">
<img src="DeltaEtvsEtdET_Score_vs_et.gif" usemap="#results" alt="" style="border-style: none;">
...
<?
	...
	for($i=1;$i<=100;$i++)
	{
		echo "<area shape=rect coords=".($xpos+($i-1)*7.36).",410,".($ypos+($i-1)*7.36).",39\n";
 		if($i<10)
 		{
 			echo "href=DeltaEtvsEt/DeltaEtvsEtCompare_etBin000".$i.".gif\n";
 			echo "onMouseOver=tn_r('000".$i."')>\n";
 		}
 		else if($i<100)
 		{
 			echo "href=DeltaEtvsEt/DeltaEtvsEtCompare_etBin00".$i.".gif\n";
...
<br>
<br>
<div id="All bins"><img src=DeltaEtvsEtdEt_Allbins.gif></div>
<div id="sigma"><img src=DeltaEtvsEtSigmaEtOverEt_vs_et.gif></div>
