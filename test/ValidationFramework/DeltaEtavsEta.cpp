...
DeltaEtavsEta::DeltaEtavsEta(PlotCompareUtility *pc)
{
	this->pc=pc;
...
void DeltaEtavsEta::histo_conf(int type)
{
	if(type==1)
	{
...
void DeltaEtavsEta::print_gifs(int type,int bin)
{
	...
	if(type==0)
	{
		...
		string et_sigma_name = name + "SigmaDeltaEta_vs_Eta.gif";
